 ...
 */
[_LOWER] = KEYMAP( \
  KC_TILD,       KC_EXLM,    KC_AT,        ES_HASH,        KC_DLR,     KC_PERC,     KC_CIRC,    KC_AMPR,        KC_ASTR      ,   ALGR(KC_4),   KC_RPRN,   KC_BSPC, \
...
,[_D] = KEYMAP( \
  ...
  _______,    _______,    _______,    _______,    _______,    _______,    _______,       KC_4,        KC_5,         KC_6,       ES_MINS,          _______, \
  _______,    _______,    _______,    _______,    _______,    _______,    _______,       KC_1,        KC_2,         KC_3,       KC_KP_PLUS,       _______, \
  _______,    _______,    _______,    _______,    _______,    _______,    _______,       KC_0,        KC_SLASH,     KC_PAST,    KC_DOT ,         _______
)
/* TEMPLATE
 *,--------------------------------------------------------------------------------------------------------------------------------------------.
 *|         |          |           |           |           |           |           |           |           |           |           |           |
