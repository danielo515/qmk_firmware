...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ergodox(KC_LEAD,TD_F1,KC_2,KC_3,KC_4,TD_F5,LCTL(KC_X),KC_DELETE,KC_Q,KC_W,KC_E,KC_R,KC_T,LCTL(KC_V),KC_TAB,KC_A,LT(3,KC_S),LT(2,KC_D),LT(4,KC_F),KC_G,KC_PIPE,KC_Z,KC_X,KC_C,KC_V,KC_B,LCTL(KC_C),LSFT(KC_LALT),OSM(MOD_LCTL),OSM(MOD_LALT),KC_LEFT,KC_RIGHT,ALT_T(KC_INSERT),KC_LGUI,KC_HOME,OSM(MOD_LSFT),LT(2,KC_BSPACE),KC_PLUS,TO(1),KC_6,KC_7,KC_8,KC_9,LT(3,KC_0),KC_DQUO,KC_UNDS,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_MINUS,H_ENTER,ALT_T(KC_J),RCTL_T(KC_K),LT(6,KC_L),KC_SCOLON,GUI_T(KC_QUOTE),ALT_TAB,KC_N,KC_M,KC_COMMA,KC_DOT,KC_SLASH,LT(4,KC_KP_ASTERISK),LT(4,KC_ENTER),KC_DOWN,KC_LBRACKET,KC_RBRACKET,OSL(2),KC_AUDIO_MUTE,KC_ESCAPE,KC_END,KC_COLN,LT(3,KC_BSPACE),LT(4,KC_SPACE)),
  [1] = LAYOUT_ergodox(
    ...
    KC_GRAVE         ,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,TD(COPY_CUT),
    KC_TRANSPARENT   ,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,
    OSM(MOD_LSFT),KC_TRANSPARENT,KC_PLUS,
    ...
    KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,
    KC_PIPE,KC_COLN,KC_TRANSPARENT),
  ...
  [8] = LAYOUT_ergodox(KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_E,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_ENTER,KC_TRANSPARENT,KC_A,KC_S,KC_D,KC_F,KC_TRANSPARENT,KC_TRANSPARENT,KC_Z,KC_X,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_SPACE,KC_TRANSPARENT,TO(0),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_PGDOWN,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_ENTER,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_SPACE),
};
