...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT,KC_TRANSPARENT,
    KC_TRANSPARENT,
    KC_PIPE,KC_LEAD,KC_TRANSPARENT),
  ...
  [4] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT     ,LCTL(KC_Q)         ,LCTL(KC_W)         ,LGUI(KC_UP)        ,LGUI(KC_DOWN)      ,LGUI(KC_LEFT)      ,LALT(LSFT(KC_UP))  ,
    LCTL(LSFT(KC_P))   ,LCTL(KC_A)         ,LCTL(KC_S)         ,LCTL(KC_D)         ,KC_TRANSPARENT     ,RGUI(KC_R)         ,
    LCTL(LSFT(KC_F))   ,LCTL(KC_Z)         ,LCTL(KC_X)         ,KC_PSCREEN         ,KC_TRANSPARENT     ,LGUI(KC_RIGHT)     ,LALT(LSFT(KC_DOWN)),
    KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,KC_TRANSPARENT     ,
    KC_TRANSPARENT     ,KC_TRANSPARENT     ,
    KC_TRANSPARENT     ,
