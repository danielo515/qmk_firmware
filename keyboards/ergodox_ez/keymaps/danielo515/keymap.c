...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_ergodox(
    ...
    KC_TRANSPARENT  ,KC_TRANSPARENT  ,
    KC_TRANSPARENT  ,
    KC_TRANSPARENT  ,KC_LEAD         ,KC_TRANSPARENT),

  [2] = LAYOUT_ergodox(
    KC_TRANSPARENT,KC_F1,KC_F2,KC_F3,KC_F4,KC_F5,KC_TRANSPARENT,KC_TRANSPARENT,KC_EXLM,KC_AT,KC_LCBR,KC_RCBR,KC_PIPE,KC_CALCULATOR,KC_TRANSPARENT,KC_HASH,KC_DLR,KC_TRANSPARENT,KC_RPRN,KC_GRAVE,KC_TRANSPARENT,KC_PERC,KC_CIRC,KC_LBRACKET,KC_RBRACKET,KC_TILD,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,RGB_TOG,RGB_HUI,KC_TRANSPARENT,KC_TRANSPARENT,RGB_HUD,KC_DELETE,KC_A,KC_B,KC_C,KC_D,KC_E,KC_BSPACE,KC_ENTER,KC_F,KC_7,KC_8,KC_9,KC_PERC,KC_TRANSPARENT,KC_HASH,KC_4,KC_5,KC_6,KC_PLUS,KC_KP_ASTERISK,KC_KP_ENTER,KC_AMPR,KC_1,KC_2,KC_3,KC_SLASH,KC_BSLASH,KC_0,KC_COMMA,KC_DOT,KC_EQUAL,KC_TRANSPARENT,RGB_MOD,RGB_SLD,RGB_VAI,RGB_VAD,KC_BSPACE,KC_SPACE
    ),

  [3] = LAYOUT_ergodox(
    RESET,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_LCBR,KC_RCBR,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_AT,KC_TRANSPARENT,KC_EQUAL,KC_RABK,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_LBRACKET,KC_RBRACKET,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LALT(LSFT(KC_UP)),KC_HASH,KC_LABK,KC_RABK,KC_KP_ASTERISK,KC_PERC,KC_DLR,KC_AMPR,KC_LPRN,KC_RPRN,KC_MINUS,KC_KP_PLUS,KC_PIPE,LALT(LSFT(KC_DOWN)),KC_EXLM,KC_TILD,KC_CIRC,KC_PLUS,KC_QUES,KC_BSLASH,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,RESET,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_SPACE
    ),
